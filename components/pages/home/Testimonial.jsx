        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <div className="text-center">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">testimonials are evidence of customers talking about your product or service in their own words. At their best, they are authentic, descriptive, and specific so that future buyers can identify with the customer, the problem, and how they solved it.</p>
                ...
                <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
                    <div className="p-8 border rounded-lg dark:border-gray-700">
                        <p className="leading-loose text-gray-500 dark:text-gray-400">
                            “My traffic stream broke down in the middle of synchronisation
                            and instead of my data i had a bunch of nonsense.
                            Automatic backups didn't work- i was NOT happy. Until i met
                            Tim from Support. Not only did he do a marvellous job calming
                            me down, he also provided me with access to my backups
                            within minutes of calling the support line.
                            Never been happier with any of my partners! Cheers to”.
                        </p>
                    ...
                    <div className="p-8 bg-primary border border-transparent rounded-lg dark:bg-primary">
                        <p className="leading-loose text-white">
                            “I had but one encounter with the lovely staff over @cashmap.
                            Time was pressing, so i might not have been the most exciting
                            customer to talk to for Tim from Support.
                            But he sure handled the situation incredibly well. I have no
                            complaints. On the contrary: The response time to my initial
                            message was impressive. Plus the
                    ...
                    <div className="p-8 border rounded-lg dark:border-gray-700">
                        <p className="leading-loose text-gray-500 dark:text-gray-400">
                            ...
                            smokes did the people over make my day today.
                            You better get a pay raise! I considered contacting the support back then
                            or filing a report. But we all know how things go - i had other
                            stuff to do. However i didn't notice that the automatic backup
                            service had apparently been turned off in the process. So i was
                            essentialy running on no security net at all. ”
                        </p>
